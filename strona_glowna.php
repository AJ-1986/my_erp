    ...
    if($_GET['auth'] == '1') {
        echo '
                    ...
                    <p class="bazowy">
                        ...
                        Na stronie tej uzyskasz informacje statystyczne dotyczące twojego statusu. Odnajdziesz tu informację o nowych dodanych kontrahentach, fakturach sprzedaży 
                        i zakupu oraz o aktualnych płatnościach dotyczących wybranego podmiotu, na którym aktualnie pracujesz.<br><br>
                        Wszystkie funkcje związane z aktualizacją danych Twojego podmiotu jak i dodawaniem nowych użytkowników systemu znajdują się w "Ustawieniach".<br><br>
